Feature: User uploads dossier
    ...
    Scenario: User Uploads a small dossier zip file
        ...
        Then they will be directed to the 'Variation Single One-Product Application-Contact-Details' page
    ...
    Scenario: User does not upload a file
        ...
        And they will be directed to the 'Variation Single One-Product Upload-Dossier' page