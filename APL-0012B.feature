Feature: User who has enterered a valid code from Data Table IA Only enters application contact information
    Description:
        Reference: APL-0012B
    
    Background: Given the user has completed the PL-0012A steps
