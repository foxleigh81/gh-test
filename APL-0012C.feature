Feature: User enters application finance information
    ...
    Background:
        ...
        And they navigate to the 'Variation Single One-Product Finance Details' page
    ...
    Scenario: User completes all mandatory fields and clicks 'continue'
        ...
        And they will be directed to the 'Variation Single One-Product Check-Your-Answers' page
    ...
    Scenario: User does not enter any information and clicks 'continue'
        When they click the 'Continue' button
        And they will be directed to the 'Variation Single One-Product Finance Details' page
