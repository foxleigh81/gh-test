Feature: User who has enterered a valid code from Data Table IB Only confirms supporting documents
    Description:
        Reference: APL-0013A
    
    Background: Given the user has completed the PL-0013 steps
