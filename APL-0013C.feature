Feature: User who has enterered a valid code from Data Table IB Only enters application contact information
    Description:
        Reference: APL-0013C
    
    Background: Given the user has completed the PL-0013B steps
