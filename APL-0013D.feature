Feature: User who has enterered a valid code from Data Table IB Only checks, and is able to change answers
    Description:
        Reference: APL-0013D
    
    Background: Given the user has completed the PL-0013C steps

    @APL-0013D
    Scenario Outline: User who has enterered a valid code from Data Table IB Only is directed to 'Check your answers' page 
