Feature: User who has enterered a valid code from Data Table II Only confirms supporting documents
    Description:
        Reference: APL-0015A
    
    Background: Given the user has completed the PL-0015 steps
