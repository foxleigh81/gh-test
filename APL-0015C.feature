Feature: UUser who has enterered a valid code from Data Table II Only enters application contact information
    Description:
        Reference: APL-0015C
    
    Background: Given the user has completed the PL-0015B steps
