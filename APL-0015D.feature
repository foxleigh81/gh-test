Feature: User who has enterered a valid code from Data Table II Only checks, and is able to change answers
    Description:
        Reference: APL-0015D
    
    Background: Given the user has completed the PL-0015C steps

    @APL-0015D
    Scenario Outline: User who has enterered a valid code from Data Table II Only is directed to 'Check your answers' page 
