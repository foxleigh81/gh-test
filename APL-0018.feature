Feature: User who has enterered a valid code from Data Table IA + IB selects the variation type
    Description:
        Reference: APL-0018
    ...
    @APL-0018
    Scenario: User who has enterered a valid code from Data Table IA + IB is directed to the 'Variation Type Page 2' page 
