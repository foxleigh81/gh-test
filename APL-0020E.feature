Feature: User who has enterered a valid code from Data Table IA + IB, and has selected IA variation type, changes the variation
    Description:
        Reference: APL-0020E
    ...
    @APL-0020E
    Scenario Outline: User who has enterered a valid code from Data Table IA + IB, and has selected IA variation type, is directed to 'Confirm Change Variation' page 
