Feature: User who has enterered a valid code from Data Table IA + IB, and has selected IB variation type, changes the variation
    Description:
        Reference: APL-0023E
    ...
    @APL-0023E
    Scenario Outline: User who has enterered a valid code from Data Table IA + IB, and has selected IB variation type, is directed to 'Confirm Change Variation' page 
