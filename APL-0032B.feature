Feature: User who has enterered a valid code from Data Table Z Only, and has selected IA variation type, Uploads dossier
    Description:
        Reference: APL-0032B
    
    Background: Given the user has completed the PL-0032A steps
