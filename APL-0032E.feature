Feature: User who has enterered a valid code from Data Table Z Only, and has selected IA variation type, changes the variation
    Description:
        Reference: APL-0032E
    ...
    @APL-0032E
    Scenario Outline: User who has enterered a valid code from Data Table Z Only, and has selected IA variation type, is directed to 'Confirm Change Variation' page 
