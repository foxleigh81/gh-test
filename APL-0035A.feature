Feature: User who has enterered a valid code from Data Table Z Only, and has selected IB variation type, confirms supporting documents
    Description:
        Reference: APL-0035A
    
    Background: Given the user has completed the PL-0035 steps
