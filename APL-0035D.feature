Feature: User who has enterered a valid code from Data Table Z Only, and has selected IB variation type, checks and is able to change answers
    Description:
        Reference: APL-0035D
    
    Background: Given the user has completed the PL-0035C steps
    ...
    Scenario Outline: User who has entered a valid code from Data Table Z Only and has selected IB variation type is directed to the 'Check your answers' page 
        ...
        And they have selected Variation Type 'IB' on the 'Variation Type 1' page
