Feature: User who has enterered a valid code from Data Table Z Only, and has selected IB variation type, changes the variation
    Description:
        Reference: APL-0035E
    
    Background: Given the user has completed the PL-0035D steps

    @APL-0035E
    Scenario Outline: User who has enterered a valid code from Data Table Z Only, and has selected IB variation type, is directed to 'Confirm Change Variation' page 
