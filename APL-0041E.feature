Feature: User who has enterered a valid code from Data Table Z Only, and has selected II variation type, changes the variation
    Description:
        Reference: APL-0041E
    ...
    @APL-0041E
    Scenario Outline: User who has enterered a valid code from Data Table Z Only, and has selected II variation type, is directed to 'Confirm Change Variation' page 
