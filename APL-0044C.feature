Feature: User who has enterered a valid code from Data Table 'No Variations' enters application contact information
    Description:
        Reference: APL-0044C
    
    Background: Given the user has completed the PL-0044B steps
