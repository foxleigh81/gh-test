Feature: User who has enterered a valid code from Data Table 'No Variations' changes the variation
    Description:
        Reference: APL-0045A
    ...
    @APL-0045A
    Scenario Outline: User who has enterered a valid code from Data Table 'No Variations' is directed to 'Confirm Change Variation' page 
