Feature: User who has enterered a valid code from Data Table Z Special enters application contact information
    Description:
        Reference: APL-0046C
    
    Background: Given the user has completed the PL-0046B steps
