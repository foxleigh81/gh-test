Feature: User who has enterered a valid code from Data Table Z Special  changes the variation
    Description:
        Reference: BPL-0047A
    ...
    @BPL-0047A
    Scenario Outline: User who has enterered a valid code from Data Table Z Special  is directed to 'Confirm Change Variation' page 
