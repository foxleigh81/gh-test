Feature: User enters a variation code
    ...
    Examples: 
        ...
        | IA.Only | IA.Only.And.Common | Variation Single Multiple-Products Implementation-Date |
        | IB.Only | IB.Only.And.Common | Variation Single Multiple-Products Describe-Changes |
        ...
        | Z.Only | Z.Only.And.Common | Variation Single Multiple-ProductsSelect Variation Type |
