Feature: User who has enterered a valid code from Data Table IB Only describes proposed changes
    Description:
        Reference: BPL-1013
    ...
    @BPL-1013
    Scenario: Use who has enterered a valid code from Data Table IB Only is directed to the 'Describe Changes' page 
