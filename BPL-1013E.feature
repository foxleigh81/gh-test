Feature: User who has entered a valid code from Data Table IB Only checks, and is able to change answers
    ...
    Background:
        Given the user has completed the PL-1013D steps

    @BPL-1013E-1
    Scenario: User who has entered a valid code from Data Table IB Only is directed to 'Check your answers' page 
        And the user has been directed to the 'Check Your Answers' page
        And they have entered a value from Data Table 'IB Only'
