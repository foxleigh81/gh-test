Feature: User who has entered a valid code from Data Table II Only checks, and is able to change answers
    ...
    Background:
        Given the user has completed the PL-1015D steps

    @BPL-1015E-1
    Scenario: User who has entered a valid code from Data Table II Only is directed to 'Check your answers' page 
        And the user has been directed to the 'Check Your Answers' page
        And they have entered a value from Data Table 'II Only'
        ...
        And a table with a row with the list item 'Variation Type' and 'II' displayed and a change link
