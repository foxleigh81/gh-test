Feature: User who has entered a valid code from Data Table II Only changes the variation
    ...
    Background:
        Given the user has completed the PL-1015E steps

    @BPL-1015F-1
    Scenario: User who has entered a valid code from Data Table II Only is directed to 'Confirm Change Variation' page 
