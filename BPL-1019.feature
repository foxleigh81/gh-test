Feature: User who has enterered a valid code from Data Table IA + IB, and has selected IA variation type, enters the implementation date
    Description:
        Reference: BPL-1019
    ...
    @BPL-1019
    Scenario: User who has enterered a valid code from Data Table IA + IB and has selected IA is directed to the 'Enter Implementation Date' page 
        Given the user has been directed to the 'Implementation Date' page
        When page 'Implementation Date' loads
        Then they will see a page header 'Enter the implementation date'
