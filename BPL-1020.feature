Feature: User who has enterered a valid code from Data Table IA + IB, and has selected IA variation type, describes the proposed changes
    Description:
        Reference: BPL-1020
    
    Background: Given the user has completed the PL-1019 steps
