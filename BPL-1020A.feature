Feature: User who has enterered a valid code from Data Table IA + IB, and has selected IA variation type, confirms supporting documents
    Description:
        Reference: BPL-1020A
    
    Background: Given the user has completed the PL-1020 steps
