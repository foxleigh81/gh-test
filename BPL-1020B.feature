Feature: User who has enterered a valid code from Data Table IA + IB, and has selected IA variation type, Uploads dossier
    Description:
        Reference: BPL-1020B
    
    Background: Given the user has completed the PL-1020A steps
