Feature: User who has enterered a valid code from Data Table IA + IB, and has selected IA variation type, enters application contact information
    Description:
        Reference: BPL-1020C
    
    Background: Given the user has completed the PL-1020B steps
