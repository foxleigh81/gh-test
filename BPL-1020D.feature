Feature: User who has enterered a valid code from Data Table IA + IB, and has selected IA variation type, checks and is able to change answers
    Description:
        Reference: BPL-1020D
    
    Background: Given the user has completed the PL-1020C steps

    @BPL-1020D
    Scenario Outline: User who has enterered a valid code from Data Table IA + IB and has selected IA variation type is directed to 'Check your answers' page 
        ...
        And they have selected Variation Type 'IA' on the 'Variation Type 2' page
