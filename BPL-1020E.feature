Feature: User who has entered a valid code from Data Table IA + IB, and has selected IA variation type, checks and is able to change answers
    ...
    Background:
        Given the user has completed the PL-1020D steps

    @BPL-1020E-1
    Scenario: User who has entered a valid code from Data Table IA + IB and has selected IA variation type is directed to 'Check your answers' page 
