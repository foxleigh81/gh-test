Feature: User who has entered a valid code from Data Table IA + IB, and has selected IA variation type, changes the variation
    ...
    Background:
        Given the user has completed the PL-1020E steps

    @BPL-1020F-1
    Scenario: User who has entered a valid code from Data Table IA + IB, and has selected IA variation type, is directed to 'Confirm Change Variation' page 
