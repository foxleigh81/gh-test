Feature: User who has enterered a valid code from Data Table IA + IB, and has selected IB variation type, confirms supporting documents
    Description:
        Reference: BPL-1023A
    
    Background: Given the user has completed the PL-1023 steps
