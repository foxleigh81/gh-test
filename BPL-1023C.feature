Feature: User who has enterered a valid code from Data Table IA + IB, and has selected IB variation type, enters application contact information
    Description:
        Reference: BPL-1023C
    
    Background: Given the user has completed the PL-1023B steps
