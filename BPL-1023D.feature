Feature: User who has enterered a valid code from Data Table IA + IB, and has selected IB variation type, checks and is able to change answers
    Description:
        Reference: BPL-1023D
    
    Background: Given the user has completed the PL-1023C steps

    @BPL-1023D
    Scenario Outline: User who has enterered a valid code from Data Table IA + IB and has selected IB variation type is directed to the 'Check your answers' page 
        Given the user has been directed to the 'Check Your Answers' page
        And they have entered a value from Data Table 'Data Table IA + IB'
        And they have selected Variation Type 'IB' on the 'Variation Type 2' page
