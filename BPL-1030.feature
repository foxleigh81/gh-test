Feature: User who has enterered a valid code from Data Table Z Only, and has selected IA variation type, answers the Article 5 question
    Description:
        Reference: BPL-1030
    
    Background: Given the user has completed the PL-1028 steps
