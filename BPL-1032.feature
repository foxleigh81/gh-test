Feature: User who has enterered a valid code from Data Table Z Only, and has selected IA variation type, describes the proposed changes
    Description:
        Reference: BPL-1032
    
    Background: Given the user has completed the PL-1030 steps
