Feature: User who has enterered a valid code from Data Table Z Only, and has selected IA variation type, confirms supporting documents
    Description:
        Reference: BPL-1032A
    
    Background: Given the user has completed the PL-1032 steps
