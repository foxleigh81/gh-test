Feature: User who has entered a valid code from Data Table Z Only, and has selected IA variation type, changes the variation
    ...
    Background:
        Given the user has completed the PL-1032E steps

    @BPL-1032F-1
    Scenario: User who has entered a valid code from Data Table Z Only, and has selected IA variation type, is directed to 'Confirm Change Variation' page 
