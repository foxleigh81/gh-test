Feature: User who has enterered a valid code from Data Table Z Only, and has selected IB variation type, describes the proposed changes
    Description:
        Reference: BPL-1035
    
    Background: Given the user has completed the PL-1034 steps
