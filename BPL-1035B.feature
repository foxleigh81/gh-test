Feature: User who has enterered a valid code from Data Table Z Only, and has selected IB variation type, Uploads dossier
    Description:
        Reference: BPL-1035B
    
    Background: Given the user has completed the PL-1035A steps
