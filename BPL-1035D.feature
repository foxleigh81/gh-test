Feature: User who has entered a valid code from Data Table Z Only, and has selected IB variation type, checks and is able to change answers
    ...
    Background: Given the user has completed the PL-1035C steps
    ...
    Scenario Outline: User who has entered a valid code from Data Table Z Only and has selected IB variation type is directed to the 'Check your answers' page 
        ...
        And a table with a row with the list item 'selected products' and the 'Add another product' displayed and a change link
        And a section header 'Add another product' with an 'Variation Details' link
        ...
        And a table with a row with the list item 'selected variation type' and the 'Article 5' displayed and a change link
