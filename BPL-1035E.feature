Feature: User who has entered a valid code from Data Table Z Only, and has selected IB variation type, checks and is able to change answers
    ...
    Background:
        Given the user has completed the PL-1035D steps

    @BPL-1035E-1
    Scenario: User who has entered a valid code from Data Table Z Only and has selected IB variation type is directed to the 'Check your answers' page 
    ...
    Scenario: User selects change link for Variation Type
        ...
        Then they are directed to the 'Variation Type 2' page
