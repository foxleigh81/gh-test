Feature: User who has entered a valid code from Data Table Z Only, and has selected IB variation type, changes the variation
    ...
    Background:
        Given the user has completed the PL-1035E steps

    @BPL-1035F-1
    Scenario: User who has entered a valid code from Data Table Z Only, and has selected IB variation type, is directed to 'Confirm Change Variation' page 
