Feature: User who has enterered a valid code from Data Table Z Only, and has selected II variation type, describes the proposed changes
    Description:
        Reference: BPL-1041
    
    Background: Given the user has completed the PL-1039 steps
