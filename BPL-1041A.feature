Feature: User who has enterered a valid code from Data Table Z Only, and has selected II variation type, confirms supporting documents
    Description:
        Reference: BPL-1041A
    
    Background: Given the user has completed the PL-1041 steps
