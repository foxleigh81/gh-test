Feature: User who has enterered a valid code from Data Table Z Only, and has selected II variation type, enters application contact information
    Description:
        Reference: BPL-1041C
    
    Background: Given the user has completed the PL-1041B steps
