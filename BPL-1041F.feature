Feature: User who has entered a valid code from Data Table Z Only, and has selected II variation type, changes the variation
    ...
    Background:
        Given the user has completed the PL-1041E steps

    @BPL-1041F-1
    Scenario: User who has entered a valid code from Data Table Z Only, and has selected II variation type, is directed to 'Confirm Change Variation' page 
