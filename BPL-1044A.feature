Feature: User who has enterered a valid code from Data Table 'No Variations' confirms supporting documents
    Description:
        Reference: BPL-1044A
    
    Background: Given the user has completed the PL-1044 steps
