Feature: User who has entered a valid code from Data Table 'No Variations' checks, and is able to change answers
    ...
    Background:
        Given the user has completed the PL-1044D steps

    @BPL-1045-1
    Scenario: User who has entered a valid code from Data table No Variations is directed to the 'Check your answers' page
        And the user has been directed to the 'Check Your Answers' page
        And they have entered a value from Data Table 'No Variations'
        ...
        And a table with a row with the list item 'N/a' and the MISSING VALUE displayed 
