Feature: User who has enterered a valid code from Data Table Z Special submits the application
    Description:
        Reference: BPL-1047A
    
    Background: Given the user has completed the PL-1047 steps
