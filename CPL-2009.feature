Feature: User enters Implementation Date 
    ...
    Scenario: User enters an implementation date
        ...
        And they will be directed to the 'Variation Type IA One-Change Multiple-Products Implementation-Date' page
        ...
        Then they will be directed to the 'Variation Type IA One-Change Multiple-Products Describe-Changes' page
    ...
    Scenario: User enters an implementation date, having previously selected 'Z Only' group code
        ...
        And they enter the number '2020' into the 'implementation date year' number input
        And they click the 'Continue' button
        Then they will be directed to the 'Variation Type IA One-Change Multiple-Products Article-5' page
