Feature: User confirms supporting documents
    ...
    Background:
        ...
        And they navigate to the 'Variation Type IA One Change Multiple-Products Supporting-Documents' page
    ...
    Scenario: User ticks all check boxes
        ...
        And they will be directed to the 'VariationType IA One-Change Multiple-Products Upload-Dossier' page
    ...
    Scenario: User ticks one check box, and does not enter reason for omission
        And they tick the box for 'Copy of the relevant page(s)'
        When they click the 'Continue' button
        Then they will be directed back to the 'Variation Type IA One-Change Multiple-Products Supporting-Documents' page
