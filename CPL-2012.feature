Feature: User who has enterered a valid code from Data Table IA Only confirms supporting documents
    Description:
        Reference: CPL-2012
    
    Background: Given the user has completed the PL-2011 steps
