Feature: User uploads dossier
    ...
    Background:
        ...
        And they navigate to the 'Variation Type IA One-Change Multiple-Products Upload-Dossier' page
    ...
    Scenario: User Uploads a small dossier zip file
        ...
        Then they will be directed to the 'Variation Type IA One-Change Multiple-Products Application-Contact-Details' page
    ...
    Scenario: User Uploads a non zip file ** Note this needs to be changed to fail
        ...
        And they click the 'Upload File Continue' button
        Then they will be directed to the 'Variation Variation Type IA One-Change Multiple-Products Application-Contact-Details' page
    ...
    Scenario: User does not upload a file
        ...
        And they will be directed to the 'Variation Type IA One-Change Multiple-Products Upload-Dossier' page