Feature: User who has entered a valid code from Data Table IA Only changes the variation
    ...
    Background:
        Given the user has completed the PL-2012D steps

    @CPL-2012E-1
    Scenario: User who has entered a valid code from Data Table IA Only is directed to 'Confirm Change Variation' page 
