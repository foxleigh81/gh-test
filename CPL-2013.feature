Feature: User who has enterered a valid code from Data Table IB Only enters Implementation Date 
    Description:
        Reference: CPL-2013
    ...
    @CPL-2013
    Scenario: Use who has enterered a valid code from Data Table IB Only is directed to 'Enter Implementation Date' page 
