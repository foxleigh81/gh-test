Feature: User who has entered a valid code from Data Table IA + IB Only checks, and is able to change answers
    ...
    Background:
        Given the user has completed the PL-2014D steps

    @CPL-2014E-1
    Scenario: User who has entered a valid code from Data Table IA + IB Only is directed to 'Check your answers' page 
