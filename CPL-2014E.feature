Feature: User who has enterered a valid code from Data Table IB Only changes the variation
    Description:
        Reference: CPL-2014E
    
    Background: Given the user has completed the PL-2014D steps

    @CPL-2014E
    Scenario Outline: User who has enterered a valid code from Data Table IB Only is directed to 'Confirm Change Variation' page 
