Feature: User who has entered a valid code from Data Table IA + IB Only changes the variation
    ...
    Background:
        Given the user has completed the PL-2014E steps

    @CPL-2014F-1
    Scenario: User who has entered a valid code from Data Table IA + IB Only is directed to 'Confirm Change Variation' page 
