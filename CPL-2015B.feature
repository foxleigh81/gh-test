Feature: User who has enterered a valid code from Data Table Z Only describes proposed changes
    Description:
        Reference: CPL-2015B
    ...
    @CPL-2015B
    Scenario: Use who has enterered a valid code from Data Table Z Only is directed to the 'Describe Changes' page 
