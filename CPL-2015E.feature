Feature: User who has entered a valid code from Data Table Z Only enters application contact information
    Description:
    ...
    Background:
        Given the user has completed the PL-2015D steps
