Feature: User who has enterered a valid code from Data Table Z Only checks, and is able to change answers
    Description:
        Reference: CPL-2015F
    ...
    @CPL-2015F
    Scenario Outline: User who has enterered a valid code from Data Table Z Only is directed to 'Check your answers' page 
