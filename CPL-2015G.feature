Feature: User who has enterered a valid code from Data Table Z Only changes the variation
    Description:
        Reference: CPL-2015G
    
    Background: Given the user has completed the PL-2015F steps

    @CPL-2015G
    Scenario Outline: User who has enterered a valid code from Data Table Z Only is directed to 'Confirm Change Variation' page 
