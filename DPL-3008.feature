Feature: User who has enterered a valid code from Data Table IA Only enters Implementation Date 
    Description:
        Reference: DPL-3008
    
    Background: Given the user has completed the PL-3007 steps

    @DPL-3008
    Scenario: Use who has enterered a valid code from Data Table IA Only is directed to 'Enter Implementation Date' page 
