Feature: User is prompted to add another variation
    ...
    Scenario: User does not add another variation
        ...
        Then they will be directed to the 'Variation Type IA Several-Changes One-Product Supporting-Documents' page

    @DPL-3014-3
    Scenario: User does not select either redio button option
        When they click the 'Continue' button
        Then they will be directed back to the 'Variation Type IA Several-Changes One-Product Add-Another-Variation-Code' page
