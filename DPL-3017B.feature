Feature: User who has entered a valid code from Data Table IA Only and a second variation code from Data Table Data Table IA + IB is prompted to add another variation
    Description:
        Reference: DPL-3017B

    Background: Given the user has completed the PL-3017 steps

    @DPL-3017B
    Scenario: User who has entered a valid code from Data Table IA Only and a second variation  code from Data Table Data Table IA + IB is directed to the Add Another Variation page
