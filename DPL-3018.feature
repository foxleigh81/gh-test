Feature: User who has entered a valid code from Data Table IA Only and a second variation code from Data Table Z Only enters Implementation Date 
    ...
    Background: Given the user has completed the PL-3011 steps

    @DPL-3018
    Scenario: User who has entered a valid code from Data Table IA Only and a second variation  code from Data Table Data Table Z Only is directed to 'Enter Implementation Date' page 
