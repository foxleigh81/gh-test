Feature: User who has entered a valid code from Data Table IA Only and a second variation  code from Data Table Data Table Z Onlydescribes the proposed changes
    Description:
        Reference: DPL-3020
