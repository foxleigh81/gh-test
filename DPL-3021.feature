Feature: User who has entered a valid code from Data Table IA Only and a second variation  code from Data Table Data Table Z Only views the application summary page
    Description:
        Reference: DPL-3021

    Background: Given the user has completed the PL-3019 steps
