Feature: User who has entered a valid code from Data Table IA Only and a second variation code from Data Table Data Table Z Only is prompted to add another variation
    Description:
        Reference: DPL-3021B

    Background: Given the user has completed the PL-3021 steps
