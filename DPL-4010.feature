Feature: User who has entered a valid code from Data Table IA or IA + IB views the Application Summary page
    Description:
        Reference: DPL-4010
    ...
    @DPL-4010-1
    Scenario Outline: User who has entered a valid code from Data Table IA + IB directed to the Application Summary page
        Given the user has been directed to the 'Application Summary' page
        And they have entered a value from Data Table '<Sub Code>'
        When page 'Application Summary' loads
        Then they will see a 'Back' link
