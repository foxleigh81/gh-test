Feature: User who has entered a valid code from Data Table IA or IA + IB removes the variation
    Description:
        Reference: DPL-4010A
    ...
    @DPL-4010A-1
    Scenario Outline: User who has entered a valid code from Data Table IA + IB is directed to Confirm Remove Variation page
        Given the user has been directed to the 'Confirm Remove Variation' page
        When page 'Confirm Remove Variation' loads
        Then they will see a 'Back' link
        And a 'Sign out' link
        ...
        And a page header 'Are you sure you want to remove variation:'
        And they will see the '<Sub Code>' displayed 
        And they will see a radio button option for '
        And they will see a radio button option for 'Yes'
        And they will see a 'Continue' option
