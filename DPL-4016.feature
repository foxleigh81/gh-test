Feature: User who has entered a valid code from Data Table IA Only or IA + IB and a second variation code from Data Table IA Only or IA + IB Uploads dossier
    Description:
        Reference: DPL-4016
