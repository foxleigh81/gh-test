Feature: User who has entered a valid code from Data Table IA Only or IA + IB and a second variation code from Data Table IA Only or IA + IB enters application contact information
    Description:
        Reference: DPL-4017

    Background: Given the user has completed the PL-4016 steps
