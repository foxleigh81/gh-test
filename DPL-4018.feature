Feature: User who has entered a valid code from Data Table IA Only or IA + IB and a second variation code from Data Table IA Only or IA + IB checks, and is able to change answers
    Description:
        Reference: DPL-4018
    ...
    @DPL-4018
    Scenario Outline: User who has entered a valid code from Data Table IA Only or IA + IB and a second variation code from Data Table IA Only or IA + IB is directed to 'Check your answers' page 
        ...
        And a table with a row with the list item 'Invoice Email Address' and the 'Further Comments' displayed and a change link
