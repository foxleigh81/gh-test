Feature: User who has entered a valid code from Data Table IA + IB and a second variation code from Data Table IA Only views the application summary page
    ...
    Background:
        Given the user has completed the PL-4042 steps

    @DPL-4043-1
    Scenario: User who has entered a valid code from Data Table IA + IB and a second variation code from Data Table IA Only is directed to the Application Summary page
