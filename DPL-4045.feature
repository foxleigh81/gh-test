Feature: User who has entered a valid code from Data Table IA + IB and a second variation code from Data Table IA Only Uploads dossier
    Description:
        Reference: DPL-4045

    Background: Given the user has completed the PL-4044 steps
