Feature: User who has entered a valid code from Data Table IA + IB and a second variation code from Data Table IA Only submits the application
    Description:
        Reference: DPL-4048

    Background: Given the user has completed the PL-4047 steps
