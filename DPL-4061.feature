Feature: User who has entered a valid code from Data Table IA + IB and a second variation code from Data Table Z Only confirms supporting documents
    Description:
        Reference: DPL-4061

    Background: Given the user has completed the PL-4060B steps
