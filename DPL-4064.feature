Feature: User who has entered a valid code from Data Table IA + IB and a second variation code from Data Table Z Only checks, and is able to change answers
    ...
    Background:
        Given the user has completed the PL-4063A steps

    @DPL-4064-1
    Scenario: User who has entered a valid code from Data Table IA + IB and a second variation code from Data Table Z Only is directed to 'Check your answers' page 
