Feature: User who has entered a valid code from Data Table IA Only  and a second variation code from Data Table IA + IB confirms supporting documents
    Description:
        Reference: DPL-4083

    Background: Given the user has completed the PL-4082B steps
