Feature: User who has entered a valid code from Data Table Z Only and a second variation code from Data Table IA + IB Uploads dossier
    Description:
        Reference: DPL-4084

    Background: Given the user has completed the PL-4083 steps
