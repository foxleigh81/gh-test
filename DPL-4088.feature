Feature: User who has entered a valid code from Data Table Z Only and a second variation code from Data Table Z Only enters Implementation Date 
    Description:
        Reference: DPL-4088

    Background: Given the user has completed the PL-4070 steps

    @DPL-4088
    Scenario: User who has entered a valid code from Data Table Z Only and a second variation code from Data Table Z Only is directed to 'Enter Implementation Date' page 
