Feature: User who has entered a valid code from Data Table IA Only and a second variation code from Data Table Z Only enters application contact information
    Description:
        Reference: DPL-4094

    Background: Given the user has completed the PL-4093 steps
