Feature: User selects products to be varied
    ...
    Scenario: User adds a product
        ...
        Then they will be directed back to the 'Variation Type IA Several-Changes Multiple-Products Select-Product-2' page
    ...
    Scenario: User does not add a product and clicks continue
        When they click the 'Continue' button
        Then they will be directed back to the 'Variation Type IA Several-Changes Multiple-Products Select-Products' page
        And they will see a warning message stating 'You must add at least two products to the list before continuing'
    ...
    Scenario: User selects 'Enter details for products not listed' link
        ...
        Then they are directed to the 'Variation Type IA Several-Changes Multiple-Products Enter-Products-2' page
    ...
    Scenario: User removes a product
        ...
        When they select 'Variation Type IA Several-Changes Multiple-Products Select-Product-2'
