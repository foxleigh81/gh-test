Feature: User enters a product which does not appear in the list on the Select product page
    ...
    Background:
        ...
        And they are directed to the 'Variation Type IA Several-Changes Multiple-Products Enter-Products-2' page
    ...
    Scenario: User adds a product 
        ...
        Then they will be directed back to the 'Variation Type IA Several-Changes Multiple-Products Enter-Products-2' page
