Feature: User answers the Article 5 question
    ...
    Background:
        ...
        And are they directed to the 'Variation Type IA Several-Changes Multiple-Products Article-5' page
    ...
    Scenario: User does not answer the Article 5 question
        ...
        Then they will be directed back to the 'Variation Type IA Several-Changes Multiple-Products Article-5' page
