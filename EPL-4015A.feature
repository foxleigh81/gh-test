Feature: User uploads dossier
    ...
    Scenario: User Uploads a small dossier zip file
        ...
        Then they will be directed to the 'Variation Type IA Several-Changes Multiple-Products Application-Contact-Details' page
    ...
    Scenario: User Uploads a non zip file ** Note this needs to be changed to fail
        ...
        And they click the 'Upload File Continue' button
        Then they will be directed to the 'Variation Variation Type IA Several-Changes Multiple-Products Application-Contact-Details' page
