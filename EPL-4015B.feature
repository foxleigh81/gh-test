Feature: User enters application contact information
    ...
    Background:
        ...
        And they navigate to the 'Variation Type IA Several-Changes Multiple-Products Application-Contact-Details' page
    ...
    Scenario: User completes all mandatory fields
        ...
        And they will be directed to the 'Variation Type IA Several-Changes Multiple-Products Finance-Details' page

    @EPL-4015B-2
    Scenario: User does not complete all mandatory fields
        When they click the 'Continue' button
        And they will be directed to the 'Variation Type IA Several-Changes Multiple-Products Application-Contact-Details' page
