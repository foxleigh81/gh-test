Feature: User who has entered a valid code from Data Table IA Only and a second variation  code from Data Table IA + IB removes a variation
    Description:
        Reference: EPL-9022A

    Background: Given the user has completed the PL-9022 steps
