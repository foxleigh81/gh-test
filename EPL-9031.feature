Feature: User who has entered a valid code from Data Table IA Only and a second variation  code from Data Table Z Only views the application summary page
    ...
    Background: Given the user has completed the PL-9030 steps

    @EPL-9031
    Scenario Outline: User who has entered a valid code from Data Table IA Only and a second variation code from Data Table Z Only is directed to the Application Summary page
