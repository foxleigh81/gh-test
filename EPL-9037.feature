Feature: User who has entered a valid code from Data Table IA + IB enters the implementation date
    Description:
        Reference: EPL-9037

    Background: Given the user has completed the PL-9007 steps
