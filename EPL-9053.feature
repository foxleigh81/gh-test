Feature: User who has entered a valid code from Data Table IA + IB and a second variation code from Data Table IA + IB Uploads dossier
    Description:
        Reference: EPL-9053

    Background: Given the user has completed the PL-9052 steps
