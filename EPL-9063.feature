Feature: User who has entered a valid code from Data Table IA + IB and a second variation code from Data Table Z Only enters application contact information
    Description:
        Reference: EPL-9063

    Background: Given the user has completed the PL-9062 steps
