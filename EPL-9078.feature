Feature: User who has entered a valid code from Data Table Z Only and a second variation code from Data Table IA Only checks, and is able to change answers
    Description:
        Reference: EPL-9078

    Background: Given the user has completed the PL-9077A steps
    ...
    Scenario Outline: User who has entered a valid code from Data Table Z Only and a second variation code from Data Table IA Only is directed to 'Check your answers' page 
        ...
        And a section header 'Proposed' with an 'proposed change text' link
