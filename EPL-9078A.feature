Feature: User who has entered a valid code from Data Table Z Only and a second variation code from Data Table IA Only removes a variation
    Description:
        Reference: EPL-9078A

    Background: Given the user has completed the PL-9078 steps
