Feature: User who has entered a valid code from Data Table Z Only and a second variation code from Data Table IA + IB submits the application
    Description:
        Reference: EPL-9087

    Background: Given the user has completed the PL-9086 steps
