Feature: User selects the variation type
    ...
    Scenario: User selects variation type IA, having previously selected 'IAIB' group code
        ...
        Then they will be directed to the 'Variation Type IB/II Several-Changes One-Product Implementation-Date' page
    ...
    Scenario: User doesnt select code and clicks continue, having previously selected 'IAIB' group code
        ...
        Then they will be directed back to the 'Variation Type IB/II Several-Changes One-Product Select-Variation-Type' page
