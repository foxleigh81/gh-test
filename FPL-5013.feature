Feature: User views the summary page
    ...
    Scenario: User views the application summary page having previously entered an IA Only code, and a second Z Only code, IA variation type, and completing all sections
        ...
        And they will see a 'Present' row with value 'Present Text' and a change link leading to 'Variation Type IB/II Several-Changes One-Product Describe-Changes'
        And they will see a 'Proposed' row with value 'Proposed Text' and a change link leading to 'Variation Type IB/IISeveral-Changes One-Product Describe-Changes'
        When they click the 'Continue' button
        Then they are directed to the 'Variation Type IB/II Several-Changes One-Product Add-Another-Variation-Code' page