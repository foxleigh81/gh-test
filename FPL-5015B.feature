Feature: User enters application contact information
    ...
    Background:
        ...
        And they navigate to the 'Variation Type IB/II Several-Changes One-Product Application-Contact-Details' page
    ...
    Scenario: User does not complete all mandatory fields
        When they click the 'Continue' button
        And they will be directed to the 'Variation Type IB/II Several-Changes One-Product Application-Contact-Details' page
