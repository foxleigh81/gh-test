Feature: User who has entered a valid code from Data Table IA Only and a second variation  code from Data Table IB Only, or II Only, or No Variations, or Z Special enters application finance information
    Description:
        Reference: FPL-5024A

    Background: Given the user has completed the PL-5024 steps
