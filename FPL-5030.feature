Feature: User who has entered a valid code from Data Table IA Only  and a second variation code from Data Table IA + IB and has selected Variation type IA views the application summary page
    ...
    Background:
        Given the user has completed the PL-5029 steps
    ...
    Scenario: User who has entered a valid code from Data Table IA Only  and a second variation code from Data Table IA + IB and has selected Variation type IA is directed to the Application Summary page
        ...
        And a table with a row with the list item 'selected procedure type' and MISSING VALUE displayed 
        ...
        And a table with a row with the list item 'variation description' and MISSING VALUE displayed 
