Feature: User who has entered a valid code from Data Table IA Only  and a second variation code from Data Table IA + IB and has selected Variation type IA confirms supporting documents
    Description:
    ...
    Background:
        Given the user has completed the PL-5030B steps
