Feature: User who has entered a valid code from Data Table IA Only and a second variation code from Data Table Z Only and has selected variation type IB or II views the application summary page
    Description:
        Epic: Procedure F: IB/II/Ext - sev ch, 1  prd 
        Reference: FPL-5055

    Background: Given the user has completed the PL-5054 steps

    @FPL-5055
    Scenario Outline: User who has entered a valid code from Data Table IA Only and a second variation code from Data Table Z Only and has selected variation type IB or II is directed to the Application Summary page
    ...
    Examples: 
        ...
        | C.II.6(a) | IA Only | IA | B.I.a.1(z) | Z Only | IB |
        | C.II.6(a) | IA Only | IA | B.I.a.1(z) | Z Only | II |
