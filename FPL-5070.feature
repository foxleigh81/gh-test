Feature: User who has entered a valid code from Data Table IB Only, II Only, No Variations, or Z Special and a second from Data Table IA Only checks, and is able to change answers
    ...
    Background: Given the user has completed the PL-5069A steps

    @FPL-5070
    Scenario Outline: User who has entered a valid code from Data Table IB Only, II Only, No Variations, or Z Special and a second from Data Table IA Only is directed to 'Check your answers' page 
