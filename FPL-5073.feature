Feature: User who has entered a valid code from Data Table IB Only, II Only, No Variations, or Z Special and a second  from Data Table IB Only, II Only, No Variations, or Z Special views the application summary page
    ...
    Background:
        Given the user has completed the PL-5072 steps

    @FPL-5073-1
    Scenario: User who has entered a valid code from Data Table IB Only, II Only, No Variations, or Z Special and a second  from Data Table IB Only, II Only, No Variations, or Z Special is directed to the Application Summary page
