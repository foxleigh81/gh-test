Feature: User who has entered a valid code from Data Table IB Only, II Only, No Variations, or Z Special and a second  from Data Table IB Only, II Only, No Variations, or Z Special submits the application
    Description:
    ...
    Background:
        Given the user has completed the PL-5077 steps
