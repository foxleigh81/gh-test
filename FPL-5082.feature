Feature: User who has entered a valid code from Data Table IB Only, II Only, No Variations, or Z Special and a second  from Data Table IA + IB and has selected variation type IA views the application summary page
    ...
    Background:
        Given the user has completed the PL-5081 steps

    @FPL-5082-1
    Scenario: User who has entered a valid code from Data Table IB Only, II Only, No Variations, or Z Special and a second  from Data Table IA + IB and has selected variation type IA is directed to the Application Summary page
