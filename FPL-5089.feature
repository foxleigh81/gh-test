Feature: User who has entered a valid code from Data Table IB Only, II Only, No Variations, or Z Special and a second  from Data Table IA + IB and has selected variation type IB views the application summary page
    ...
    Background: Given the user has completed the PL-5088 steps

    @FPL-5089
    Scenario Outline: User who has entered a valid code from Data Table IB Only, II Only, No Variations, or Z Special and a second  from Data Table IA + IB and has selected variation type IB is directed to the Application Summary page
