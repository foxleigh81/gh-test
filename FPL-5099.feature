Feature: User who has entered a valid code from Data Table IB Only, II Only, No Variations, or Z Special and a second from Data Table Z Only and has selected variation type IA views the application summary page
    Description:
        Epic: Procedure F: IB/II/Ext - sev ch, 1  prd 
        Reference: FPL-5099

    Background: Given the user has completed the PL-5098 steps

    @FPL-5099
    Scenario Outline: User who has entered a valid code from Data Table IB Only, II Only, No Variations, or Z Special and a second from Data Table Z Only and has selected variation type IA is directed to the Application Summary page
    ...
    Examples: 
        ...
        | B.I.a.1(h) | IB Only | IB | B.I.a.1(z) | Z Only | IA |
        | B.I.a.1(b) | II Only | II | B.I.a.1(z) | Z Only | IA |
        | 1(a) | No Variations | N/a | B.I.a.1(z) | Z Only | IA |
        | A(z).1 | Z Special | N/a | B.I.a.1(z) | Z Only | IA |
