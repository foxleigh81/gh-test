Feature: User who has entered a valid code from Data Table IB Only, II Only, No Variations, or Z Special and a second from Data Table Z Only and has selected variation type IA  checks, and is able to change answers
    ...
    Background:
        Given the user has completed the PL-5102A steps

    @FPL-5103-1
    Scenario: User who has entered a valid code from Data Table IB Only, II Only, No Variations, or Z Special and a second from Data Table Z Only and has selected variation type IA is directed to 'Check your answers' page 
        ...
        And a section header 'Variation 2' with an MISSING VALUE link
        And a section header 'Code' with a 'Change' link
        ...
        And a section header 'entered implementation Date' with a 'Change' link
