Feature: User who has entered a valid code from Data Table IA + IB and has selected variation type IA enters the implementation date
    Description:
        Epic: Procedure F: IB/II/Ext - sev ch, 1  prd 
        Reference: FPL-5114

    Background: Given the user has completed the PL-5113 steps
