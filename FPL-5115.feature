Feature: User who has entered a valid code from Data Table IA + IB and has selected variation type IA describes proposed changes
    Description:
        Epic: Procedure F: IB/II/Ext - sev ch, 1  prd 
        Reference: FPL-5115

    Background: Given the user has completed the GS-512 steps
