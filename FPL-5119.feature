Feature: User who has entered a valid code from Data Table IA + IB and has selected variation type IA, and a second variation code from Data Table IA Onlydescribes the proposed changes
    Description:
        Epic: Procedure F: IB/II/Ext - sev ch, 1  prd 
        Reference: FPL-5119

    Background: Given the user has completed the PL-5118 steps

    @FPL-5119
    Scenario: User who has entered a valid code from Data Table IA + IB and has selected variation type IA, and a second variation code from Data Table IA Only is directed to 'Describe Changes' page 
