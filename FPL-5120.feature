Feature: User who has entered a valid code from Data Table IA + IB and has selected variation type IA, and a second variation code from Data Table IA Only views the application summary page
    ...
    Background: Given the user has completed the PL-5119 steps

    @FPL-5120
    Scenario Outline: User who has entered a valid code from Data Table IA + IB and has selected variation type IA, and a second variation code from Data Table IA Only is directed to the Application Summary page
