Feature: User who has entered a valid code from Data Table IA + IB and has selected variation type IA, and a second variation code from Data Table IA Only is prompted to add another variation
    Description:
        Epic: Procedure F: IB/II/Ext - sev ch, 1  prd 
        Reference: FPL-5120B

    Background: Given the user has completed the PL-5120 steps

    @FPL-5120B
    Scenario: User who has entered a valid code from Data Table IA + IB and has selected variation type IA, and a second variation code from Data Table IA Only is directed to the Add Another Variation page
