Feature: User who has entered a valid code from Data Table IA + IB and has selected variation type IA, and a second variation code from Data Table IA Only checks, and is able to change answers
    ...
    Background:
        Given the user has completed the PL-5123A steps

    @FPL-5124-1
    Scenario: User who has entered a valid code from Data Table IA + IB and has selected variation type IA, and a second variation code from Data Table IA Only is directed to 'Check your answers' page 
