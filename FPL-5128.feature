Feature: User who has entered a valid code from Data Table IA + IB and has selected variation type IA, and a second variation  code from Data Table IB Only, or II Only, or No Variations, or Z Special confirms supporting documents
    Description:
        Epic: Procedure F: IB/II/Ext - sev ch, 1  prd 
        Reference: FPL-5128

    Background: Given the user has completed the PL-5127B steps
