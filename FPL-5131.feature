Feature: User who has entered a valid code from Data Table IA + IB and has selected variation type IA, and a second variation  code from Data Table IB Only, or II Only, or No Variations, or Z Special checks, and is able to change answers
    Description:
        Epic: Procedure F: IB/II/Ext - sev ch, 1  prd 
        Reference: FPL-5131

    Background: Given the user has completed the PL-5130A steps

    @FPL-5131
    Scenario Outline: User who has entered a valid code from Data Table IA + IB and has selected variation type IA, and a second variation  code from Data Table IB Only, or II Only, or No Variations, or Z Special is directed to 'Check your answers' page 
    ...
    Examples: 
        ...
        | B.I.a.1(h) | IB Only | IB | A.4 | IA + IB | IA |
        | B.I.a.1(b) | II Only | II | A.4 | IA + IB | IA |
        | 1(a) | No Variations | N/a | A.4 | IA + IB | IA |
        | A(z).1 | Z Special | N/a | A.4 | IA + IB | IA |
