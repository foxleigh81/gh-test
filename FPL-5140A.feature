Feature: User who has entered a valid code from Data Table IA + IB and has selected variation type IA, and a second variation code from Data Table IA + IB and has selected Variation type IA removes a variation
    Description:
