Feature: User who has entered a valid code from Data Table IA + IB and has selected variation type IA and a second variation code from Data Table Z Only and has selected variation type IB or II describes the proposed changes
    Description:
