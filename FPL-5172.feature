Feature: User who has entered a valid code from Data Table IA + IB and has selected variation type IB views the Application Summary page
    ...
    Background:
        Given the user has completed the PL-5171 steps

    @FPL-5172-1
    Scenario: User who has entered a valid code from Data Table IA + IB and has selected variation type IB is directed to the Application Summary page
