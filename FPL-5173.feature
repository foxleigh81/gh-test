Feature: User who has entered a valid code from Data Table IA + IB and has selected variation type IB adds another variation
    Description:
        Epic: Procedure F: IB/II/Ext - sev ch, 1  prd 
        Reference: FPL-5173

    Background: Given the user has completed the PL-5172 steps

    @FPL-5173
    Scenario: User who has entered a valid code from Data Table IA + IB and has selected variation type IB is directed to Enter Second Variation Code page
    ...
    @FPL-5173-2
    Scenario Outline: User enters a valid code from Data Table IB Only, or II Only, or No Variations, or Z Special
        Given the user can see a text input box
