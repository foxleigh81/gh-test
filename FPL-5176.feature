Feature: User who has entered a valid code from Data Table IA + IB and has selected variation type IB and a second from Data Table IA Only views the Application Summary page
    ...
    Background: Given the user has completed the PL-5175 steps

    @FPL-5176
    Scenario Outline: User who has entered a valid code from Data Table IA + IB and has selected variation type IBand a second from Data Table IA Only is directed to the Application Summary page
