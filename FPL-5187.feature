Feature: User who has entered a valid code from Data Table IA + IB and has selected variation type IB and a second  from Data Table IB Only, II Only, No Variations, or Z Special checks, and is able to change answers
    ...
    Background: Given the user has completed the PL-5186A steps

    @FPL-5187
    Scenario Outline: User who has entered a valid code from Data Table IA + IB and has selected variation type IB and a second  from Data Table IB Only, II Only, No Variations, or Z Special is directed to 'Check your answers' page 
