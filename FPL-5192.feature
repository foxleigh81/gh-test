Feature: User who has entered a valid code from Data Table IA + IB and has selected variation type IB and a second  from Data Table IA + IB and has selected variation type IA views the application summary page
    ...
    Background: Given the user has completed the PL-5191 steps

    @FPL-5192
    Scenario Outline: User who has entered a valid code from Data Table IA + IB and has selected variation type IB and a second  from Data Table IA + IB and has selected variation type IA is directed to the Application Summary page
