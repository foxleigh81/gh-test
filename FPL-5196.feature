Feature: User who has entered a valid code from Data Table IA + IB and has selected variation type IB and a second  from Data Table IA + IB and has selected variation type IA checks, and is able to change answers
    ...
    Background: Given the user has completed the PL-5195A steps

    @FPL-5196
    Scenario Outline: User who has entered a valid code from Data Table IA + IB and has selected variation type IB and a second  from Data Table IA + IB and has selected variation type IA is directed to 'Check your answers' page 
