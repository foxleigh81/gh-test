Feature: User who has entered a valid code from Data Table IA + IB and has selected variation type IB  and a second  from Data Table IA + IB and has selected variation type IB views the application summary page
    ...
    Background: Given the user has completed the PL-5198 steps

    @FPL-5199
    Scenario Outline: User who has entered a valid code from Data Table IA + IB and has selected variation type IB and a second  from Data Table IA + IB and has selected variation type IB is directed to the Application Summary page
