Feature: User who has entered a valid code from Data Table IA + IB and has selected variation type IB and a second from Data Table IA + IB and has selected variation type IB submits the application
    Description:
        Epic: Procedure F: IB/II/Ext - sev ch, 1  prd 
        Reference: FPL-5204

    Background: Given the user has completed the PL-5203 steps
