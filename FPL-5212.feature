Feature: User who has entered a valid code from Data Table IA + IB and has selected variation type IB and a second from Data Table Z Onlyy and has selected variation type IA  enters application contact information
    Description:
        Epic: Procedure F: IB/II/Ext - sev ch, 1  prd 
        Reference: FPL-5212

    Background: Given the user has completed the PL-5211 steps
