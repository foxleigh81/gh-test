Feature: User who has entered a valid code from Data Table IA + IB and has selected variation type IBl and a second from Data Table Z Only and has selected variation type IB or II  answers the Article 5 question
    ...
    @FPL-5215
    Scenario: User who has entered a valid code from Data Table IA + IB and has selected variation type IB  and a second from Data Table Z Only and has selected variation type IB or II is directed to the 'Article 5' page 
