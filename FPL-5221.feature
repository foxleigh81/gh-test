Feature: User who has entered a valid code from Data Table IA + IB and has selected variation type IB and a second from Data Table Z Only and has selected variation type IB or II checks, and is able to change answers
    Description:
    ...
    Background:
        Given the user has completed the PL-5220A steps

    @FPL-5221-1
    Scenario: User who has entered a valid code from Data Table IA + IB and has selected variation type IB  and a second from Data Table Z Only and has selected variation type IB or II is directed to 'Check your answers' page 
        ...
        And a section header 'Article 5' with a 'Change' link
