Feature: User who has entered a valid code from Data Table Z Only and has selected variation type IA removes the variation
    Description:
        Epic: Procedure F: IB/II/Ext - sev ch, 1  prd 
        Reference: FPL-5227A

    Background: Given the user has completed the PL-5227 steps

    @FPL-5227A
    Scenario Outline: User who has entered a valid code from Data Table Z Only is directed to the Confirm Remove Variation page
