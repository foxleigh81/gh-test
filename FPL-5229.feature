Feature: User who has entered a valid code from Data Table Z Only and has selected variation type IA, and a second variation code from Data Table IA Only enters Implementation Date 
    Description:
    ...
    @FPL-5229
    Scenario: User who has entered a valid code from Data Table Z Only and has selected variation type IA, and a second variation code from Data Table IA Only  is directed to 'Enter Implementation Date' page 
