Feature: User who has entered a valid code from Data Table Z Only and has selected variation type IA, and a second variation  code from Data Table IB Only, or II Only, or No Variations, or Z Special views the application summary page
    ...
    Background: Given the user has completed the PL-5237 steps

    @FPL-5238
    Scenario Outline: User who has entered a valid code from Data Table Z Only and has selected variation type IA, and a second variation  code from Data Table IB Only, or II Only, or No Variations, or Z Special is directed to the Application Summary page
