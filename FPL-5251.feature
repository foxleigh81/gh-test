Feature: User who has entered a valid code from Data Table Z Only and has selected variation type IA, and a second variation code from Data Table IA + IB and has selected Variation type IA checks, and is able to change answers
    Description:
        Epic: Procedure F: IB/II/Ext - sev ch, 1  prd 
        Reference: FPL-5251

    Background: Given the user has completed the PL-5250A steps

    @FPL-5251
    Scenario Outline: User who has entered a valid code from Data Table Z Only and has selected variation type IA, and a second variation code from Data Table IA + IB and has selected Variation type IA is directed to 'Check your answers' page 
    ...
    @FPL-5251-4
    Scenario Outline: User selects Remove variation link for Variation 1
    ...
    @FPL-5251-5
    Scenario Outline: User selects Remove variation link for Variation 2
