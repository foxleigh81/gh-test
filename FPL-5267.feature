Feature: User who has entered a valid code from Data Table Z Only and has selected variation type IA, and a second from Data Table Z Only and has selected variation type IA  checks, and is able to change answers
    Description:
        Epic: Procedure F: IB/II/Ext - sev ch, 1  prd 
        Reference: FPL-5267

    Background: Given the user has completed the PL-5266A steps

    @FPL-5267
    Scenario Outline: User who has entered a valid code from Data Table Z Only and has selected variation type IA, and a second from Data Table Z Only and has selected variation type IA is directed to 'Check your answers' page 
