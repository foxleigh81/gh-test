Feature: User who has entered a valid code from Data Table Z Only and has selected variation type IA, and a second from Data Table Z Only and has selected variation type IA  submits the application
    Description:
        Epic: Procedure F: IB/II/Ext - sev ch, 1  prd 
        Reference: FPL-5268

    Background: Given the user has completed the PL-5267 steps
