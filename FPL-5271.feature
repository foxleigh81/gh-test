Feature: User who has entered a valid code from Data Table Z Only and has selected variation type IA, and a second from Data Table Z Only and has selected variation type IB or II views the application summary page
    ...
    Background:
        Given the user has completed the PL-5270 steps

    @FPL-5271-1
    Scenario: User who has entered a valid code from Data Table Z Only and has selected variation type IA, and a second from Data Table Z Only and has selected variation type IB or II is directed to the Application Summary page
