Feature: User who has entered a valid  code from Data Table Z Only and has selected variation type IB or II answers the Article 5 question
    Description:
        Epic: Procedure F: IB/II/Ext - sev ch, 1  prd 
        Reference: FPL-5277

    Background: Given the user has completed the PL-5223 steps

    @FPL-5277
    Scenario: User who has entered a valid  code from Data Table Z Only and has selected variation type IB or II is directed to 'Article 5' page 
