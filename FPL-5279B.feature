Feature: User who has entered a valid  code from Data Table Z Only and has selected variation type IB or II  is prompted to add another variation
    Description:
        Epic: Procedure F: IB/II/Ext - sev ch, 1  prd 
        Reference: FPL-5279B

    Background: Given the user has completed the PL-5055 steps

    @FPL-5279B
    Scenario: User who has entered a valid  code from Data Table Z Only and has selected variation type IB or II is directed to the Add Another Variation page
