Feature: User who has entered a valid  code from Data Table Z Only and has selected variation type IB or II and a second variation  code from Data Table IA Only describes the proposed changes
    Description:
        Epic: Procedure F: IB/II/Ext - sev ch, 1  prd 
        Reference: FPL-5282

    Background: Given the user has completed the PL-5281 steps

    @FPL-5282
    Scenario: User who has entered a valid  code from Data Table Z Only and has selected variation type IB or II and a second variation  code from Data Table IA Only is directed to 'Describe Changes' page 
