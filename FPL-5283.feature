Feature: User who has entered a valid  code from Data Table Z Only and has selected variation type IB or II and a second variation code from Data Table IA Only views the application summary page
    Description:
        Epic: Procedure F: IB/II/Ext - sev ch, 1  prd 
        Reference: FPL-5283

    Background: Given the user has completed the PL-5282 steps

    @FPL-5283
    Scenario Outline: User who has entered a valid  code from Data Table Z Only and has selected variation type IB or II and a second variation code from Data Table IA Only is directed to the Application Summary page
