Feature: User who has entered a valid  code from Data Table Z Only and has selected variation type IB or II and a second variation code from Data Table IA Only is prompted to add another variation
    Description:
        Epic: Procedure F: IB/II/Ext - sev ch, 1  prd 
        Reference: FPL-5283B

    Background: Given the user has completed the PL-5283 steps

    @FPL-5283B
    Scenario: User who has entered a valid  code from Data Table Z Only and has selected variation type IB or IIand a second variation code from Data Table IA Only is directed to the Add Another Variation page
