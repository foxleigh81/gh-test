Feature: User who has entered a valid  code from Data Table Z Only and has selected variation type IB or II and a second variation code from Data Table IA Only Uploads dossier
    Description:
        Epic: Procedure F: IB/II/Ext - sev ch, 1  prd 
        Reference: FPL-5285

    Background: Given the user has completed the PL-5284 steps
