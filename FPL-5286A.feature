Feature: User who has entered a valid  code from Data Table Z Only and has selected variation type IB or IIand a second variation code from Data Table IA Only enters application finance information
    Description:
        Epic: Procedure F: IB/II/Ext - sev ch, 1  prd 
        Reference: FPL-5286A

    Background: Given the user has completed the PL-5286 steps
