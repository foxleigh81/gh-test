Feature: User who has entered a valid  code from Data Table Z Only and has selected variation type IB or II and a second variation code from Data Table IA Only checks, and is able to change answers
    Description:
    ...
    Background:
        Given the user has completed the PL-5286A steps

    @FPL-5287-1
    Scenario: User who has entered a valid  code from Data Table Z Only and has selected variation type IB or II and a second variation code from Data Table IA Only is directed to 'Check your answers' page 
        ...
        And a table with a row with the list item 'Variation Type' and the MISSING VALUE displayed 
        And a section header '<Var Type A>' with a 'Change' link
