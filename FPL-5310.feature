Feature: User who has entered a valid  code from Data Table Z Only and has selected variation type IB or II, and a second variation code from Data Table IA + IB and has selected Variation type IB checks, and is able to change answers
    Description:
        Epic: Procedure F: IB/II/Ext - sev ch, 1  prd 
        Reference: FPL-5310

    Background: Given the user has completed the PL-5309A steps

    @FPL-5310
    Scenario Outline: User who has entered a valid  code from Data Table Z Only and has selected variation type IB or II, and a second variation code from Data Table IA + IB and has selected Variation type IB is directed to 'Check your answers' page 
        ...
        And a table with a row with the list item '<Var Type B>' and the 'Article 5' displayed and a change link
        ...
        And a table with a row with the list item 'Variation description' and 'Variation Type' displayed and a change link
        And a table with a row with the list item '<Var Type A>' and the 'Present' displayed and a change link
        And a table with a row with the list item 'present text' and the 'Proposed' displayed and a change link
    ...
    Examples: 
        ...
        | A.3 | IA + IB | IB | B.I.a.1(z) | Z Only | IB |
        | A.3 | IA + IB | IB | B.I.a.1(z) | Z Only | II |
