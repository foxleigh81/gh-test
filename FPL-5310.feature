Feature: User who has entered a valid  code from Data Table Z Only and has selected variation type IB or II, and a second variation code from Data Table IA + IB and has selected Variation type IB checks, and is able to change answers
    ...
    Background:
        Given the user has completed the PL-5309A steps

    @FPL-5310-1
    Scenario: User who has entered a valid  code from Data Table Z Only and has selected variation type IB or II, and a second variation code from Data Table IA + IB and has selected Variation type IB is directed to 'Check your answers' page 
