Feature: User who has entered a valid  code from Data Table Z Only and has selected variation type IB or II, and a second variation code from Data Table Z Only and has selected variation type IA enters the implementation date
    Description:
        Epic: Procedure F: IB/II/Ext - sev ch, 1  prd 
        Reference: FPL-5313

    Background: Given the user has completed the PL-5312 steps

    @FPL-5313
    Scenario: User who has entered a valid  code from Data Table Z Only and has selected variation type IB or II, and a second variation code from Data Table Z Only and has selected variation type IA is directed to the 'Enter Implementation Date' page 
