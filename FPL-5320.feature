Feature: User who has entered a valid  code from Data Table Z Only and has selected variation type IB or II, and a second variation code from Data Table Z Only and has selected variation type IA  checks, and is able to change answers
    ...
    Background: Given the user has completed the PL-5319A steps

    @FPL-5320
    Scenario Outline: User who has entered a valid  code from Data Table Z Only and has selected variation type IB or II, and a second variation code from Data Table Z Only and has selected variation type IA is directed to 'Check your answers' page 
