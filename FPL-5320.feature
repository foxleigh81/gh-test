Feature: User who has entered a valid  code from Data Table Z Only and has selected variation type IB or II, and a second variation code from Data Table Z Only and has selected variation type IA  checks, and is able to change answers
    Description:
    ...
    Background:
        Given the user has completed the PL-5319A steps

    @FPL-5320-1
    Scenario: User who has entered a valid  code from Data Table Z Only and has selected variation type IB or II, and a second variation code from Data Table Z Only and has selected variation type IA is directed to 'Check your answers' page 
        ...
        And a table with a row containing the list item '<Var Type B>' and the MISSING VALUE displayed and a 'Remove variation' link 
