Feature: User who has entered a valid  code from Data Table Z Only and has selected variation type IB or II, and a second variation code from Data Table Z Only and has selected variation type IB or II views the application summary page
    Description:
        Epic: Procedure F: IB/II/Ext - sev ch, 1  prd 
        Reference: FPL-5324

    Background: Given the user has completed the PL-5323 steps

    @FPL-5324
    Scenario Outline: User who has entered a valid  code from Data Table Z Only and has selected variation type IB or II, and a second variation code from Data Table Z Only and has selected variation type IB or II is directed to the Application Summary page
    ...
    Examples: 
        ...
        | B.I.a.1(z) | Z Only | IB | B.I.a.1(z) | Z Only | IB |
        | B.I.a.1(z) | Z Only | II | B.I.a.1(z) | Z Only | II |
