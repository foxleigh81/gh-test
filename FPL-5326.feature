Feature: User who has entered a valid  code from Data Table Z Only and has selected variation type IB or II, and a second variation code from Data Table Z Only and has selected variation type IB or II Uploads dossier
    Description:
        Epic: Procedure F: IB/II/Ext - sev ch, 1  prd 
        Reference: FPL-5326

    Background: Given the user has completed the PL-50325 steps
