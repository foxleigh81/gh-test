Feature: User who has entered a valid  code from Data Table Z Only and has selected variation type IB or II, and a second variation code from Data Table Z Only and has selected variation type IB or II checks, and is able to change answers
    Description:
    ...
    Background:
        Given the user has completed the PL-50327A steps

    @FPL-5328-1
    Scenario: User who has entered a valid  code from Data Table Z Only and has selected variation type IB or II, and a second variation code from Data Table Z Only and has selected variation type IB or II is directed to 'Check your answers' page 
        ...
        And a table with a row containing the list item '<Var Type A>' and the MISSING VALUE displayed and a 'Remove variation' link 
        And a table with a row with the list item 'Article 5' and MISSING VALUE displayed and a change link
