Feature: User uploads dossier
    ...
    Scenario: User Uploads a small dossier zip file
        ...
        Then they will be directed to the 'Variation Type IB/II Several-Changes Multiple-Products Application-Contact-Details' page
    ...
    Scenario: User does not upload a file
        ...
        And they will be directed to the 'Variation Type IB/II Several-Changes Multiple-Products Upload DossierVariation Type IB/II Several-Changes Multiple-Products Upload-Dossier' page