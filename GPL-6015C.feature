Feature: User enters application finance information
    ...
    Background:
        ...
        And they navigate to the 'Variation Type IB/II Several-Changes Multiple-Products Finance-Details' page
    ...
    Scenario: User completes all mandatory fields and clicks 'continue'
        ...
        And they will be directed to the 'Variation Type IB/II Several-Changes Multiple-Products Check-Your-Answers' page
    ...
    Scenario: User does not enter any information and clicks 'continue'
        When they click the 'Continue' button
        And they will be directed to the 'Variation Type IB/II Several-Changes Multiple-Products Finance-Details' page
