Feature: User enters a variation code
    ...
    Examples: 
        ...
        | IA.Only | IA.Only.And.Common | Variation Workshare One-Change Multiple-Products Implementation-Date |
        | IB.Only | IB.Only.And.Common | Variation Workshare One-Change Multiple-Products Describe-Changes |
        | II.Only |  | Variation Workshare One-Change Multiple-Products Describe-Changes |
        | Num.Variation |  | Variation Workshare One-Change Multiple-Products Describe-Changes |
        | Z.Special |  | Variation Workshare One-Change Multiple-Products Describe-Changes |
        | IA.IB |  | Variation Workshare One-Change Multiple-Products Select Variation Type |
        | Z.Only | Z.Only.And.Common | Variation Workshare One-Change Multiple-Products Select Variation Type |
    ...
    Scenario: User does not enter a valid code or select a radio button option
        ...
        Then they will be directed back to the  'Variation Workshare One-Change Multiple-Products Enter Variation Code' page
