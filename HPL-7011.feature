Feature: User describes proposed changes
    ...
    Scenario: User Enters describes proposed changes
        ...
        And they will be directed to the 'Variation Workshare One-Change Multiple-Products Supporting Documents' page
    ...
    Scenario: User does not enter text for present situation
        And they enter the text 'Proposed' into the 'Proposed Solution' text area
        When they click the 'Continue' button
        Then they will be directed back to the 'Variation Workshare One-Change Multiple-Products Describe Changes' page
