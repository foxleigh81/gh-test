Feature: User answers the Article 5 question
    ...
    Scenario: User answers the Article 5 question
        ...
        Then they will be directed to the 'Variation Workshare One-Change Multiple-Products Describe-Changes' page

    @HPL-7011A-2
    Scenario: User does not answer the Article 5 question
        When they click the 'Continue' button
        Then they will be directed back to the 'Variation Workshare One-Change Multiple-Products Article-5' page
