Feature: User uploads dossier
    ...
    Scenario: User Uploads a small dossier zip file
        ...
        Then they will be directed to the 'Variation Workshare One-Change Multiple-Products Application-Contact-Details' page
    ...
    Scenario: User does not upload a file
        ...
        And they will be directed to the 'Variation Workshare One-Change Multiple-Products Upload-Dossier' page