Feature: User enters application contact information
    ...
    Background:
        ...
        And they navigate to the 'Variation Workshare One-Change Multiple-Products Application Contact Details' page
    ...
    Scenario: User completes all mandatory fields
        ...
        And they are directed to the 'Variation Workshare One-Change Multiple-Products Finance Details' page

    @HPL-7012B-2
    Scenario: User does not complete all mandatory fields
        When they click the 'Continue' button
        And they are directed to the 'Variation Workshare One-Change Multiple-Products Application-Contact-Details' page
