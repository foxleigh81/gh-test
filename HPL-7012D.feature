Feature: User checks their answers
    ...
    Scenario: User checks their answers, having previously selected an 'IB Only And Common' code and completing all sections
        ...
        And they will see a 'Procedure Option' row with value 'One change to several unrelated products' and a change link leading to 'Variation Workshare Procedure-Options'
        And they will see a 'Product(s)' row with value 'Selected product' and a change link leading to 'Variation Workshare One-Change Multiple-Products Select-Product-2'
        ...
        Then they will be directed to the 'Variation Workshare One-Change Multiple-Products Declaration' page
    ...
    Scenario: User checks thier answers having not completed all sections
        ...
        And they will see a section header 'Finance Details' with status 'completed' and a change link leading to 'Variation Workshare One-Change Multiple-Products Finance-Details'
        When they click the 'Continue' button
        Then they will be directed back to the 'Variation Workshare One-Change Multiple-Products Check-Your-Answers' page
    ...
    Scenario: User replaces the variation
        And they resume the incomplete application where product name contains 'HPL-7012D-8'
        And they navigate to the 'Variation Workshare One-Change Multiple-Products Check-Your-Answers' page
        And they can see a 'Code' row with value 'IA.Only' and a replace link 
        When they select the 'Replace' link for 'IA.Only'
        Then they will be directed to the 'Variation Workshare One-Change Multiple-Products Enter-Variation-Code' page