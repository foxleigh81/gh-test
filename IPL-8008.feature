Feature: User selects the variation type
    ...
    Scenario: User selects variation type IA, having previously selected 'IAIB' group code
        ...
        And they will be directed to the 'Variation Workshare Several-Changes Multiple-Products Select-Variation-Type' page
    ...
    Scenario: User doesnt select code and clicks continue, having previously selected 'IAIB' group code
        ...
        Then they will be directed back to the 'Variation Workshare Several-Changes Multiple-Products Select-Variation-Type' page
    ...
    Scenario: User selects variation type IB, having previously selected 'Z Only' group code
        ...
        And a 'Continue' button
        When they select the 'IB' option and click continue
        Then they will be directed to the 'Variation Workshare Several-Changes Multiple-Products Article-5' page
    ...
    Scenario: User navigates to page, having previously selected 'IA Only' group code
        ...
        And they will be directed to the 'Variation Workshare Several-Changes Multiple-Products Implementation-Date' page
