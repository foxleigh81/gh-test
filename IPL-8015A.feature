Feature: User uploads dossier
    ...
    Scenario: User Uploads a small dossier zip file
        ...
        Then they are directed to the 'Variation Workshare Several-Changes Multiple-Products Application-Contact-Details' page
    ...
    Scenario: User does not upload a file
        ...
        And they are directed to the 'Variation Workshare Several-Changes Multiple-Products Upload DossierVariation Workshare Several-Changes Multiple-Products Upload-Dossier' page