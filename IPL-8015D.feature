Feature: User checks their answers
    ...
    Scenario: User checks their answers having previously entered an IA Only code, and a second IA Only code, and completing all sections
        ...
        And they will see a 'Procedure Option' row with value 'Several changes to several unrelated products' and a change link leading to 'Variation Workshare Procedure-Options'
        ...
        And they will see a 'Code' row with value 'C.II.6(a)' and a replace link leading to 'Variation Workshare Several-Changes Multiple-Products Confirm-Change-Variation-Code'
        ...
        Then they will be directed to the 'Variation Workshare Several-Changes Multiple-Products Declaration' page
    ...
    Scenario: User checks their answers having previously entered an IA Only code, and a second Z Only code,IB variation type, and completing all sections
        ...
        And they will see a 'Code' row with value 'B.I.a(z)' and a replace link leading to 'Variation Workshare Several-Changes Multiple-Products Confirm-Change-Variation-Code'
    ...
    Scenario: User checks their answers having previously entered an IAIB Only code,IB variation type, and a second Z Only code,IA variation type, and completing all sections
        ...
        And they will see a 'Code' row with value 'B.I.a.1(i)' and a replace link leading to 'Variation Workshare Several-Changes Multiple-Products Confirm-Change-Variation-Code'
        And they will see a 'Description' row with value 'Introduction of a new site of micronisation'
        And they will see a 'Variation Type' row with value 'IB'
        And they will see a 'Present' row with value 'Present Text' and a change link leading to 'Variation Workshare Several-Changes Multiple-Products Describe-Changes'
        And they will see a 'Proposed' row with value 'Proposed Text' and a change link leading to 'Variation Workshare Several-Changes Multiple-Products Describe-Changes'
    ...
    Scenario: User checks their answers having not completed all sections
        ...
        And they will see a section header 'Finance Details' with status 'completed' and a change link leading to 'Variation Workshare Several-Changes Multiple-Products Finance-Details'
        When they click the 'Continue' button
        Then they will be directed back to the 'Variation Workshare Several-Changes Multiple-Products Check-Your-Answers' page
    ...
    Scenario: User selects the 'Add another product' link
        ...
        Then they will be directed to the 'Variation Workshare Several-Changes Multiple-Products Select-product-2' page
    ...
    Scenario: User who has completed two variation sections replaces a variation
        ...
        Then they will be directed to the 'Variation Workshare Several-Changes Multiple-Products Add-Another-Variation-Code' page
    ...
    Scenario: User who has completed more than two variation sections removes a variation
        ...
        Then they will be directed to the 'Variation Workshare Several-Changes Multiple-Products Check-Your-Answers' page
